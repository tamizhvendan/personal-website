...
As shown in the [initial example](#why-fsconfig), FsConfig allows us to group similar configuration into a record type.
...
If you are curious to know how FsConfig works and its internals then you might be interested in my blog post, [Generic Programming Made Easy](/blog/generic-programming-made-easy.md) that deep dives into the initial implementation of FsConfig.
